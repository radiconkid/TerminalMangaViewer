...
## [0.7.5] - 2026-07-23 (バグ修正)

Kitty端末の画像表示品質を向上                                                                                                                                       
Sixel対応ターミナルと読書方向切り替え機能を追加                                                                                                                     



## [0.7.4] - 2026-07-23 (バグ修正)

Kitty画像表示の改善とWindows/ANSI環境対応                                                                                                                           
ANSIステータス表示と画像描画の順序最適化                                                                                                                            



## [0.7.3] - 2026-07-23 (バグ修正)

ターミナル表示時の画像高さ計算を修正                                                                                                                                
Windows向け端末セルピクセルサイズ取得機能を追加                                                                                                                     
端末セルの物理ピクセルサイズに基づくアスペクト比計算機能を追加                                                                                                      
バージョンを 0.7.2 に更新                                                                                                                                           



## [0.7.2] - 2026-07-23 (バグ修正)

画像表示と入力処理を改善                                                                                                                                            
WezTermRendererを削除しSixelRendererをデフォルトに                                                                                                                  
読みモードに応じたキーマッピングを実装                                                                                                                              
バージョンを0.7.0から0.7.1に更新                                                                                                                                    



## [0.7.1] - 2026-07-22 (バグ修正)
